...
Scheme
{
	...
	{
		// Team Colors
		"BlueTeamColor"		"32 105 244 255" // rgb(33,150,243) rgb(32,105,244)
		"BlueTeamColorDark"	"11 81 214 255" // rgb(25,118,210) rgb(11,81,214)

		"RedTeamColor"		"244 32 105 255" // rgb(244,67,54) rgb(244,32,105)
		"RedTeamColorDark"	"214 11 81 255" // rgb(211,47,47) rgb(214,11,81)
		...
		"BlueColor"			"32 105 244 255" // rgb(30,136,229)
		"BlueColorDark"		"11 81 214 255" // rgb(21,101,192)

		"RedColor"			"244 32 105 255"
		"RedColorDark"		"214 11 81 255"
		...
		// For Main Menu
		"MainBackground"		"0 0 0 255"		// Main Menu Background Color (Dunno if that was obvious enough).

		// For Backpack, Crafting, etc.
		"MenuBackground"		"0 0 0 255"		// Background Color for all Menus.
